...
describe PlatformApiClient do
  before(:each) do
    ...
    stub_request(:get, "#{ENV['PLATFORM_API_BASE_URL']}items/sierra-nypl/12082323").to_return(status: 200, body: File.read('./spec/fixtures/bib.json'))
  end
  ...
  it "should authenticate when calling with :authenticate => true" do
    ...
    expect(client.get('items/sierra-nypl/12082323', authenicate: true)).to be_a(Object)
